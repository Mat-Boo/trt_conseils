...
class CandidatureRepository extends ServiceEntityRepository
{
    ...
    /**
     * Permet d'afficher les offres d'emploi postulées en attente de validation par un consultant
     */
    public function findNonApprovedCandidatures()
    {
        return $this->createQuerybuilder('c')
            ->andWhere('c.is_approved = 0')
            ->getQuery()
            ->getResult();
    }

    /**
     * Permet d'afficher les offres d'emploi postulées validées par un consultant
     */
    public function findApprovedCandidatures()
    {
        return $this->createQuerybuilder('c')
            ->andWhere('c.is_approved = 1')
            ->getQuery()
            ->getResult();
    }
